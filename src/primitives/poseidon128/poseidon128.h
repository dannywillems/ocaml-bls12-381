...
// Computing for batched partial rounds
...
#define NB_CONSTANTS_FOR_UNBATCHED_PARTIAL_ROUNDS_TMP_VAR                 \
  (NB_TMP_VAR + WIDTH * NB_TMP_VAR + (NB_TMP_VAR * (NB_TMP_VAR - 1) / 2))
...
// Computing for the remaining partial rounds. We batch them. The only diff with above is the batch_size = r_p mod batch_size

#define NB_TMP_VAR_UNBATCHED ((NB_UNBATCHED_PARTIAL_ROUNDS - 1))
#define NB_CONSTANTS_UNBATCHED_PARTIAL_ROUNDS   \
  ((NB_UNBATCHED_PARTIAL_ROUNDS * WIDTH))
#define NB_CONSTANTS_FOR_UNBATCHED_PARTIAL_ROUNDS_TMP_VAR                 \
  (NB_TMP_VAR_UNBATCHED + WIDTH * NB_TMP_VAR_UNBATCHED + (NB_TMP_VAR_UNBATCHED * (NB_TMP_VAR_UNBATCHED - 1) / 2))
#define NB_CONSTANTS_FOR_UNBATCHED_PARTIAL_ROUNDS_FINAL_COMPUTATION \
  ((NB_TMP_VAR_UNBATCHED + WIDTH) * WIDTH + WIDTH)
#define NB_CONSTANTS_FOR_UNBATCHED_PARTIAL_ROUNDS                 \
  ((NB_CONSTANTS_PER_UNBATCHED_PARTIAL_ROUNDS_TMP_VAR +           \
    NB_CONSTANTS_PER_UNBATCHED_PARTIAL_ROUNDS_FINAL_COMPUTATION))
#define NB_CONSTANTS_FOR_UNBATCHED_PARTIAL_ROUNDS                             \
  ((NB_UNBATCHED_PARTIAL_ROUNDS * NB_CONSTANTS_FOR_UNBATCHED_PARTIAL_ROUNDS))
